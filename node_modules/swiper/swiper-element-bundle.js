    ...
    if (needNavigationInit) {
      if (swiper.isElement) {
        if (!nextEl || typeof nextEl === 'string') {
          ...
          setInnerHTML$1(nextEl, swiper.hostEl.constructor.nextButtonSvg);
        ...
        if (!prevEl || typeof prevEl === 'string') {
          ...
          setInnerHTML$1(prevEl, swiper.hostEl.constructor.prevButtonSvg);
